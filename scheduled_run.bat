...
echo [info] python: E:\documents\zixun\.venv\Scripts\python.exe >> "%~dp0logs\run.log"
"E:\documents\zixun\.venv\Scripts\python.exe" "E:\documents\zixun\main.py" >> "%~dp0logs\run.log" 2>&1
